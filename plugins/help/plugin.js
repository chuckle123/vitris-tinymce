...
var help = (function () {
  ...
  var never$1 = $_6047unasjfh9qak9.never;
  var always$1 = $_6047unasjfh9qak9.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_6047unasjfh9qak9.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var $_a7vwrtaujfh9qakf = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_aeeop1aqjfh9qajs.map($_a7vwrtaujfh9qakf.shortcuts, function (shortcut) {
  ...
  var $_5l9112apjfh9qajm = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_hwyfeazjfh9qakx.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_hwyfeazjfh9qakx.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_hwyfeazjfh9qakx.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_hwyfeazjfh9qakx.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_9g16wpb0jfh9qaky.head(str).bind(function (head) {
      return $_9g16wpb0jfh9qaky.tail(str).map(function (tail) {
  ...
  var $_25e3fhb1jfh9qal0 = { urls: urls };

  var makeLink = $_6047unasjfh9qak9.curry($_96dza6ayjfh9qakt.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_aeeop1aqjfh9qajs.find($_25e3fhb1jfh9qal0.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_3wro2saxjfh9qakr.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_aeeop1aqjfh9qajs.filter(keys, $_6047unasjfh9qak9.not($_6047unasjfh9qak9.curry($_aeeop1aqjfh9qajs.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_aeeop1aqjfh9qajs.map(pluginKeys, function (key) {
  ...
  var $_dn5k27awjfh9qakj = { makeTab: makeTab$1 };
  ...
  var $_8g9oijb2jfh9qal2 = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_5l9112apjfh9qajm.makeTab(),
          $_dn5k27awjfh9qakj.makeTab(editor)
        ],
        buttons: $_8g9oijb2jfh9qal2.makeRow(),
  ...
  var $_3kyeziaojfh9qajk = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_3kyeziaojfh9qajk.open(editor, pluginUrl));
  };
  var $_8wo31danjfh9qajj = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_3kyeziaojfh9qajk.open(editor, pluginUrl)
    });
  ...
  var $_cihatgb4jfh9qal4 = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_cihatgb4jfh9qal4.register(editor, pluginUrl);
    $_8wo31danjfh9qajj.register(editor, pluginUrl);
