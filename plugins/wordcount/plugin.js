...
var wordcount = (function () {
  ...
  var $_41sitjs6jfh9qdhd = {
    each: each,
    map: map
  };

  var SETS$1 = $_7zspp2s4jfh9qdh8.SETS;
  var OTHER = $_7zspp2s4jfh9qdh8.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_41sitjs6jfh9qdhd.map(string.split(''), memoized);
  };
  var $_2o8m60s5jfh9qdhb = { classify: classify };

  var ci = $_7zspp2s4jfh9qdh8.characterIndices;
  ...
  var $_aq28rws7jfh9qdhe = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_7zspp2s4jfh9qdh8.EMPTY_STRING;
  var WHITESPACE$1 = $_7zspp2s4jfh9qdh8.WHITESPACE;
  var PUNCTUATION$1 = $_7zspp2s4jfh9qdh8.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_2o8m60s5jfh9qdhb.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_aq28rws7jfh9qdhe.isWordBoundary(map, i)) {
  ...
  var $_cojksvs3jfh9qdh5 = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_cojksvs3jfh9qdh5.getWords(getTextContent(editor)).length;
  };
  var $_6l83zzs2jfh9qdh4 = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_6l83zzs2jfh9qdh4.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_g1jjwjs1jfh9qdh3 = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_6l83zzs2jfh9qdh4.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_aiez8vs8jfh9qdhh = { setup: setup };

  global.add('wordcount', function (editor) {
    $_aiez8vs8jfh9qdhh.setup(editor);
    return $_g1jjwjs1jfh9qdh3.get(editor);
  });
  function Plugin () {
  }
