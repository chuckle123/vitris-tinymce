...
var spellchecker = (function () {
  ...
  var $_dw0xadj1jfh9qbpf = { hasProPlugin: hasProPlugin };
  ...
  var defaultSpellcheckCallback = function (editor, pluginUrl, currentLanguageState) {
    return function (method, text, doneCallback, errorCallback) {
      ...
      global$3.send({
        url: new global$2(pluginUrl).toAbsolute($_2kkfstj3jfh9qbpi.getRpcUrl(editor)),
        type: 'post',
        ...
        error: function () {
          var message = editor.translate('The spelling service was not found: (') + $_2kkfstj3jfh9qbpi.getRpcUrl(editor) + editor.translate(')');
          errorCallback(message);
        }
      });
    };
  ...
  var sendRpcCall = function (editor, pluginUrl, currentLanguageState, name, data, successCallback, errorCallback) {
    var userSpellcheckCallback = $_2kkfstj3jfh9qbpi.getSpellcheckerCallback(editor);
  ...
  var finish = function (editor, startedState, textMatcherState) {
    ...
    if (startedState.get()) {
      ...
      $_14ktlhj8jfh9qbpz.fireSpellcheckEnd(editor);
      return true;
    }
  };
  ...
  var markErrors = function (editor, startedState, textMatcherState, lastSuggestionsState, data) {
    ...
    getTextMatcher(editor, textMatcherState).find($_2kkfstj3jfh9qbpi.getSpellcheckerWordcharPattern(editor)).filter(function (match) {
    ...
    $_14ktlhj8jfh9qbpz.fireSpellcheckStart(editor);
  };
  var $_e3837mj4jfh9qbps = {
  ...
  var get = function (editor, startedState, lastSuggestionsState, textMatcherState, currentLanguageState, url) {
    ...
    var getWordCharPattern = function () {
      return $_2kkfstj3jfh9qbpi.getSpellcheckerWordcharPattern(editor);
    };
    var markErrors = function (data) {
      $_e3837mj4jfh9qbps.markErrors(editor, startedState, textMatcherState, lastSuggestionsState, data);
    };
  ...
  var $_cgjwtpj2jfh9qbpg = { get: get };

  var register = function (editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState) {
    editor.addCommand('mceSpellCheck', function () {
      $_e3837mj4jfh9qbps.spellcheck(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
    });
  };
  var $_9aa7z7jajfh9qbqb = { register: register };
  ...
  var getItems = function (editor) {
    return global$1.map($_2kkfstj3jfh9qbpi.getLanguages(editor).split(','), function (langPair) {
  ...
  var $_g14yqtjbjfh9qbqd = { register: register$1 };
  ...
  var showSuggestions = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState, word, spans) {
    ...
    global$1.each(suggestions, function (suggestion) {
      items.push({
        ...
        onclick: function () {
          ...
          $_e3837mj4jfh9qbps.checkIfFinished(editor, startedState, textMatcherState);
        }
      });
    });
    items.push({ text: '-' });
    ...
    if (hasDictionarySupport) {
      items.push({
        ...
        onclick: function () {
          $_e3837mj4jfh9qbps.addToDictionary(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, word, spans);
        }
      });
    }
    items.push.apply(items, [
      {
        text: 'Ignore',
        onclick: function () {
          $_e3837mj4jfh9qbps.ignoreWord(editor, startedState, textMatcherState, word, spans);
        }
      },
      {
        text: 'Ignore all',
        onclick: function () {
          $_e3837mj4jfh9qbps.ignoreWord(editor, startedState, textMatcherState, word, spans, true);
        }
      }
    ]);
  ...
  var setup = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState) {
    editor.on('click', function (e) {
      ...
      if (target.className === 'mce-spellchecker-word') {
        e.preventDefault();
        var spans = $_e3837mj4jfh9qbps.findSpansByIndex(editor, $_e3837mj4jfh9qbps.getElmIndex(target));
        if (spans.length > 0) {
          var rng = editor.dom.createRng();
  ...
  var $_aqi28zjcjfh9qbqg = { setup: setup };

  global.add('spellchecker', function (editor, pluginUrl) {
    if ($_dw0xadj1jfh9qbpf.hasProPlugin(editor) === false) {
      var startedState = Cell(false);
      var currentLanguageState = Cell($_2kkfstj3jfh9qbpi.getLanguage(editor));
      var textMatcherState = Cell(null);
      var lastSuggestionsState = Cell(null);
      $_g14yqtjbjfh9qbqd.register(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState);
      $_aqi28zjcjfh9qbqg.setup(editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState);
      $_9aa7z7jajfh9qbqb.register(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
      return $_cgjwtpj2jfh9qbpg.get(editor, startedState, lastSuggestionsState, textMatcherState, currentLanguageState, pluginUrl);
    }
  });
  function Plugin () {
  }
