...
var toc = (function () {
  ...
  var $_ed2on2r0jfh9qdd9 = { create: create };

  var tocId = $_ed2on2r0jfh9qdd9.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_1x9nd9qzjfh9qdd8.getTocClass(editor);
    var headerTag = $_1x9nd9qzjfh9qdd8.getTocHeader(editor);
    var selector = generateSelector($_1x9nd9qzjfh9qdd8.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_1x9nd9qzjfh9qdd8.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_1x9nd9qzjfh9qdd8.getTocHeader(editor), global$2.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_1conecqvjfh9qdcx.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_1conecqvjfh9qdcx.updateToc(editor);
    });
  };
  var $_1f3i8wqujfh9qdcv = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_1x9nd9qzjfh9qdd8.getTocClass(editor);
  ...
  var $_bmolesr1jfh9qdda = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_1conecqvjfh9qdcx.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_1x9nd9qzjfh9qdd8.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_feqze7r2jfh9qddb = { register: register$1 };

  global.add('toc', function (editor) {
    $_1f3i8wqujfh9qdcv.register(editor);
    $_feqze7r2jfh9qddb.register(editor);
    $_bmolesr1jfh9qdda.setup(editor);
  });
  function Plugin () {
  }
