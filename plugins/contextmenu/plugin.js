...
var contextmenu = (function () {
  ...
  var $_784jxva4jfh9qah7 = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_13syn7a3jfh9qah6.getContextMenu(editor);
  ...
  var $_3zqxqxa7jfh9qahb = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_13syn7a3jfh9qah6.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_3zqxqxa7jfh9qahb.show(editor, $_784jxva4jfh9qah7.getPos(editor, e), visibleState, menu);
    });
  };
  var $_8ekzzja2jfh9qah4 = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_8ekzzja2jfh9qah4.setup(editor, visibleState, menu);
    return $_6rd2pja1jfh9qah2.get(visibleState);
  });
  function Plugin () {
  }
