...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_4ptfrl8ejfh9qa8s.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_4ptfrl8ejfh9qa8s.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_4ptfrl8ejfh9qa8s.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_4ptfrl8ejfh9qa8s.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_4ptfrl8ejfh9qa8s.getAutoResizeBottomMargin(editor);
    ...
    if ($_4ptfrl8ejfh9qa8s.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_40mpk58bjfh9qa8p.resize(editor, oldSize);
    });
  };
  var $_d62p378ajfh9qa8n = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_d62p378ajfh9qa8n.register(editor, oldSize);
      $_40mpk58bjfh9qa8p.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
