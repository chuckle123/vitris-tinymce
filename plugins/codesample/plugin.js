...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_cki2m69pjfh9qaep.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_egr60z9ljfh9qad0.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_fto70t9njfh9qad5.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_5th52l9qjfh9qaer = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_f97w0v9kjfh9qacu = {
    open: function (editor) {
      var minWidth = $_egr60z9ljfh9qad0.getDialogMinWidth(editor);
      var minHeight = $_egr60z9ljfh9qad0.getDialogMinHeight(editor);
      var currentLanguage = $_5th52l9qjfh9qaer.getCurrentLanguage(editor);
      var currentLanguages = $_5th52l9qjfh9qaer.getLanguages(editor);
      var currentCode = $_fto70t9njfh9qad5.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_fto70t9njfh9qad5.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_cki2m69pjfh9qaep.isCodeSample(node)) {
        $_f97w0v9kjfh9qacu.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_ey03g69jjfh9qact = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_cki2m69pjfh9qaep.trimArg($_cki2m69pjfh9qaep.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_cki2m69pjfh9qaep.trimArg($_cki2m69pjfh9qaep.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_23pkp9rjfh9qaet = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_egr60z9ljfh9qad0.getContentCss(editor);
  ...
  var $_ehy6kq9sjfh9qaew = { loadCss: loadCss };
  ...
  var $_8qsd3d9tjfh9qaey = { register: register$1 };

  var addedInlineCss = Cell(false);
  global$1.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_23pkp9rjfh9qaet.setup(editor);
    $_8qsd3d9tjfh9qaey.register(editor);
    $_ey03g69jjfh9qact.register(editor);
    editor.on('init', function () {
      $_ehy6kq9sjfh9qaew.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_cki2m69pjfh9qaep.isCodeSample(ev.target)) {
        $_f97w0v9kjfh9qacu.open(editor);
      }
    });
  });
