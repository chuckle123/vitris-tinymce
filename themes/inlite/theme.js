...
var inlite = (function () {
  ...
  var $_3vmg9f16jjfh9qgl8 = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_c59u0i16njfh9qgle.fromClientRect(clientRect)) : null;
  };
  var $_716zef16mjfh9qgld = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_aaeyn616ljfh9qglb.result(predicateIds[i].id, $_716zef16mjfh9qgld.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_aaeyn616ljfh9qglb.result(predicateIds[x].id, $_716zef16mjfh9qgld.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_aaeyn616ljfh9qglb.result(id, $_716zef16mjfh9qgld.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_aaeyn616ljfh9qglb.result(id, $_716zef16mjfh9qgld.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_2ok9fd16wjfh9qglq.isArray(value)) {
      return value;
    } else if ($_2ok9fd16wjfh9qglq.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_2ok9fd16wjfh9qglq.isBoolean(value)) {
  ...
  var $_7ezd2016vjfh9qglo = {
    getStringOr: getByTypeOr($_2ok9fd16wjfh9qglq.isString),
    getBoolOr: getByTypeOr($_2ok9fd16wjfh9qglq.isBoolean),
    getNumberOr: getByTypeOr($_2ok9fd16wjfh9qglq.isNumber),
    getHandlerOr: getByTypeOr($_2ok9fd16wjfh9qglq.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_2ok9fd16wjfh9qglq.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_c59u0i16njfh9qgle.toClientRect(targetRect),
        contentAreaRect: $_c59u0i16njfh9qgle.toClientRect(contentAreaRect),
        panelRect: $_c59u0i16njfh9qgle.toClientRect(panelRect)
      });
      return $_c59u0i16njfh9qgle.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_7ezd2016vjfh9qglo.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_7ezd2016vjfh9qglo.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_7ezd2016vjfh9qglo.getHandlerOr(editor, 'inline_toolbar_position_handler', $_1x72in16xjfh9qglr.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_dkfckq16sjfh9qglk.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_dfjlss16tjfh9qglm.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_dfjlss16tjfh9qglm.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_fqki9z16rjfh9qglj = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_3vmg9f16jjfh9qgl8.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_37ovwb16ojfh9qglf.fromContextToolbars(toolbars);
    result = $_aaeyn616ljfh9qglb.match(editor, [
      $_eyu87p16kjfh9qgla.element(elements[0], contextToolbarsPredicateIds),
      $_e82j8516qjfh9qglh.textSelection('text'),
      $_e82j8516qjfh9qglh.emptyTextBlock(elements, 'insert'),
      $_eyu87p16kjfh9qgla.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_aaeyn616ljfh9qglb.match(editor, [$_e82j8516qjfh9qglh.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_fqki9z16rjfh9qglj.load(editor, function () {
  ...
  var $_7khhth16fjfh9qgl4 = { renderUI: renderUI };
  ...
  var never$1 = $_edupdk172jfh9qgm8.never;
  var always$1 = $_edupdk172jfh9qgm8.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_edupdk172jfh9qgm8.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_76ebfi179jfh9qgn7.parseBox(settings.border);
      self.paddingBox = $_76ebfi179jfh9qgn7.parseBox(settings.padding);
      self.marginBox = $_76ebfi179jfh9qgn7.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_u2rdz17hjfh9qgnp.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_76ebfi179jfh9qgn7.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_76ebfi179jfh9qgn7.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_76ebfi179jfh9qgn7.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_a6v6m717gjfh9qgno.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_u2rdz17hjfh9qgnp.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_u2rdz17hjfh9qgnp.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_5e9tt517ijfh9qgns = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_u2rdz17hjfh9qgnp.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_u2rdz17hjfh9qgnp.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_2hytdv170jfh9qgly.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_2hytdv170jfh9qgly.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_76ebfi179jfh9qgn7.parseBox(self.settings.border);
          ...
          self.borderBox = $_76ebfi179jfh9qgn7.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_7khhth16fjfh9qgl4.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_6v4zce16ejfh9qgl3 = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_gd5zdr181jfh9qgpl.resolve(name, scope);
  };
  ...
  var $_1jo5dw180jfh9qgpj = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_1jo5dw180jfh9qgpj.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_ebl7pj17yjfh9qgpf = { blobToBase64: blobToBase64 };
  ...
  var $_d97b50184jfh9qgpo = { pickFile: pickFile };
  ...
  var $_3kvh52186jfh9qgps = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_7bqdsd188jfh9qgpv.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_7bqdsd188jfh9qgpv.resolve(dom, bookmark));
  };
  ...
  var $_g7io76187jfh9qgpt = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_3kvh52186jfh9qgps.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_g7io76187jfh9qgpt.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_d6zxpz185jfh9qgpq.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_d97b50184jfh9qgpo.pickFile().then(function (files) {
          var blob = files[0];
          $_ebl7pj17yjfh9qgpf.blobToBase64(blob).then(function (base64) {
            $_d6zxpz185jfh9qgpq.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_d6zxpz185jfh9qgpq.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_2ne6o617xjfh9qgpe = { addToEditor: addToEditor };
  ...
  var $_cmk4kc18cjfh9qgqf = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_egqq1218ejfh9qgqk.isAbsolute(href) && $_egqq1218ejfh9qgqk.isDomainLike(href) ? askAboutPrefix(editor, href) : global$13.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_d6zxpz185jfh9qgpq.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_d6zxpz185jfh9qgpq.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_9qobay18djfh9qgqi = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_2ok9fd16wjfh9qglq.isArray(items)) {
      return items;
    } else if ($_2ok9fd16wjfh9qglq.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_2ok9fd16wjfh9qglq.isFunction(button)) {
            button = button();
          }
  ...
  var $_e9339z18fjfh9qgql = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_e9339z18fjfh9qgql.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_e9339z18fjfh9qgql.create(editor, 'text', $_dfjlss16tjfh9qglm.getTextSelectionToolbarItems(editor)),
        $_e9339z18fjfh9qgql.create(editor, 'insert', $_dfjlss16tjfh9qglm.getInsertToolbarItems(editor)),
        $_9qobay18djfh9qgqi.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_dfjlss16tjfh9qglm.getPositionHandler(editor);
      contentAreaRect = $_716zef16mjfh9qgld.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_1x72in16xjfh9qglr.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_1x72in16xjfh9qglr.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_cmk4kc18cjfh9qgqf.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_1x72in16xjfh9qglr.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_716zef16mjfh9qgld.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_1x72in16xjfh9qglr.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_1x72in16xjfh9qglr.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_dkfckq16sjfh9qglk.fireBeforeRenderUI(editor);
  ...
  var $_6caoqo192jfh9qgsj = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_edupdk172jfh9qgm8.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_dw6wpu193jfh9qgsl = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_c8999i197jfh9qgsw = { cached: cached };

  var $_4s2jhv199jfh9qgsy = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_4s2jhv199jfh9qgsy.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_4s2jhv199jfh9qgsy.ELEMENT);
  var isText = isType$1($_4s2jhv199jfh9qgsy.TEXT);
  var isDocument = isType$1($_4s2jhv199jfh9qgsy.DOCUMENT);
  var $_8bxrh8198jfh9qgsx = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_8bxrh8198jfh9qgsx.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_c8999i197jfh9qgsw.cached(function () {
    return getBody($_dw6wpu193jfh9qgsl.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_dw6wpu193jfh9qgsl.fromDom(body);
  };
  var $_ap36g2196jfh9qgsu = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_2hytdv170jfh9qgly.each(fields, function (name, i) {
        struct[name] = $_edupdk172jfh9qgm8.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_8x5wh519bjfh9qgt8.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_2hytdv170jfh9qgly.each(array, function (a) {
      if (!$_8x5wh519bjfh9qgt8.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_2hytdv170jfh9qgly.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_89hzmt19gjfh9qgtg.validateStrArr('required', required);
    $_89hzmt19gjfh9qgtg.validateStrArr('optional', optional);
    $_89hzmt19gjfh9qgtg.checkDupes(everything);
    return function (obj) {
      var keys = $_a6bbue19fjfh9qgtd.keys(obj);
      var allReqd = $_2hytdv170jfh9qgly.forall(required, function (req) {
        return $_2hytdv170jfh9qgly.contains(keys, req);
      });
      if (!allReqd)
        $_89hzmt19gjfh9qgtg.reqMessage(required, keys);
      var unsupported = $_2hytdv170jfh9qgly.filter(keys, function (key) {
        return !$_2hytdv170jfh9qgly.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_89hzmt19gjfh9qgtg.unsuppMessage(unsupported);
      var r = {};
      $_2hytdv170jfh9qgly.each(required, function (req) {
        r[req] = $_edupdk172jfh9qgm8.constant(obj[req]);
      });
      $_2hytdv170jfh9qgly.each(optional, function (opt) {
        r[opt] = $_edupdk172jfh9qgm8.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_8hfdbn19cjfh9qgt9 = {
    immutable: Immutable,
  ...
  var $_3ebljb19hjfh9qgth = { toArray: toArray };

  var node = function () {
    var f = $_1jo5dw180jfh9qgpj.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_81k56319njfh9qguh.unknown()
    });
  };
  ...
  var $_fdtlru19mjfh9qgud = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_edupdk172jfh9qgm8.constant(edge),
    chrome: $_edupdk172jfh9qgm8.constant(chrome),
    ie: $_edupdk172jfh9qgm8.constant(ie),
    opera: $_edupdk172jfh9qgm8.constant(opera),
    firefox: $_edupdk172jfh9qgm8.constant(firefox),
    safari: $_edupdk172jfh9qgm8.constant(safari)
  };
  ...
  var $_4rdji19ojfh9qguj = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_edupdk172jfh9qgm8.constant(windows$1),
    ios: $_edupdk172jfh9qgm8.constant(ios),
    android: $_edupdk172jfh9qgm8.constant(android),
    linux: $_edupdk172jfh9qgm8.constant(linux),
    osx: $_edupdk172jfh9qgm8.constant(osx),
    solaris: $_edupdk172jfh9qgm8.constant(solaris),
    freebsd: $_edupdk172jfh9qgm8.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_edupdk172jfh9qgm8.constant(isiPad),
      isiPhone: $_edupdk172jfh9qgm8.constant(isiPhone),
      isTablet: $_edupdk172jfh9qgm8.constant(isTablet),
      isPhone: $_edupdk172jfh9qgm8.constant(isPhone),
      isTouch: $_edupdk172jfh9qgm8.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_edupdk172jfh9qgm8.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_2hytdv170jfh9qgly.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_81k56319njfh9qguh.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_81k56319njfh9qguh.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_e81k5319tjfh9qgv8.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_e81k5319tjfh9qgv8.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_e81k5319tjfh9qgv8.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_e81k5319tjfh9qgv8.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_1uet7x19ujfh9qgva.head(str).bind(function (head) {
      return $_1uet7x19ujfh9qgva.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_6rntl119sjfh9qgv4.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_6rntl119sjfh9qgv4.contains(uastring, 'edge/') && $_6rntl119sjfh9qgv4.contains(uastring, 'chrome') && $_6rntl119sjfh9qgv4.contains(uastring, 'safari') && $_6rntl119sjfh9qgv4.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_6rntl119sjfh9qgv4.contains(uastring, 'chrome') && !$_6rntl119sjfh9qgv4.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_6rntl119sjfh9qgv4.contains(uastring, 'msie') || $_6rntl119sjfh9qgv4.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_6rntl119sjfh9qgv4.contains(uastring, 'safari') || $_6rntl119sjfh9qgv4.contains(uastring, 'mobile/')) && $_6rntl119sjfh9qgv4.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_6rntl119sjfh9qgv4.contains(uastring, 'iphone') || $_6rntl119sjfh9qgv4.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_fzowpa19rjfh9qguv = {
    browsers: $_edupdk172jfh9qgm8.constant(browsers),
    oses: $_edupdk172jfh9qgm8.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_fzowpa19rjfh9qguv.browsers();
    var oses = $_fzowpa19rjfh9qguv.oses();
    var browser = $_a9rci319qjfh9qgur.detectBrowser(browsers, userAgent).fold($_fdtlru19mjfh9qgud.unknown, $_fdtlru19mjfh9qgud.nu);
    var os = $_a9rci319qjfh9qgur.detectOs(oses, userAgent).fold($_4rdji19ojfh9qguj.unknown, $_4rdji19ojfh9qguj.nu);
  ...
  var $_4udh6319ljfh9qguc = { detect: detect$2 };

  var detect$3 = $_c8999i197jfh9qgsw.cached(function () {
    var userAgent = navigator.userAgent;
    return $_4udh6319ljfh9qguc.detect(userAgent);
  });
  var $_9vkw0s19kjfh9qgu8 = { detect: detect$3 };

  var ELEMENT = $_4s2jhv199jfh9qgsy.ELEMENT;
  var DOCUMENT = $_4s2jhv199jfh9qgsy.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_2hytdv170jfh9qgly.map(base.querySelectorAll(selector), $_dw6wpu193jfh9qgsl.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_dw6wpu193jfh9qgsl.fromDom);
  };
  var $_6pw25z19vjfh9qgvc = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_2hytdv170jfh9qgly.exists(elements, $_edupdk172jfh9qgm8.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_gac8ev19jjfh9qgu6.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_9vkw0s19kjfh9qgu8.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_aa5pc219ijfh9qgtw = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_6pw25z19vjfh9qgvc.is
  };

  var owner = function (element) {
    return $_dw6wpu193jfh9qgsl.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_dw6wpu193jfh9qgsl.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_dw6wpu193jfh9qgsl.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_dw6wpu193jfh9qgsl.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_2hytdv170jfh9qgly.findIndex(kin, function (elem) {
        return $_aa5pc219ijfh9qgtw.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_8x5wh519bjfh9qgt8.isFunction(isRoot) ? isRoot : $_edupdk172jfh9qgm8.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_dw6wpu193jfh9qgsl.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_2hytdv170jfh9qgly.filter(elements, function (x) {
        return !$_aa5pc219ijfh9qgtw.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_dw6wpu193jfh9qgsl.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_dw6wpu193jfh9qgsl.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_dw6wpu193jfh9qgsl.fromDom);
  };
  var prevSiblings = function (element) {
    return $_2hytdv170jfh9qgly.reverse($_3ebljb19hjfh9qgth.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_3ebljb19hjfh9qgth.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_2hytdv170jfh9qgly.map(dom.childNodes, $_dw6wpu193jfh9qgsl.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_dw6wpu193jfh9qgsl.fromDom);
  };
  ...
  var spot = $_8hfdbn19cjfh9qgt9.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_24704q19ajfh9qgt0 = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_ap36g2196jfh9qgsu.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_2hytdv170jfh9qgly.filter($_24704q19ajfh9qgt0.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_2hytdv170jfh9qgly.filter($_24704q19ajfh9qgt0.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_2hytdv170jfh9qgly.filter($_24704q19ajfh9qgt0.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_2hytdv170jfh9qgly.each($_24704q19ajfh9qgt0.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_6pw25z19vjfh9qgvc.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_e5i66m195jfh9qgsr.ancestors(scope, function (e) {
      return $_6pw25z19vjfh9qgvc.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_e5i66m195jfh9qgsr.siblings(scope, function (e) {
      return $_6pw25z19vjfh9qgvc.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_e5i66m195jfh9qgsr.children(scope, function (e) {
      return $_6pw25z19vjfh9qgvc.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_6pw25z19vjfh9qgvc.all(selector, scope);
  };
  var $_bdwu98194jfh9qgsq = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_2hytdv170jfh9qgly.map($_bdwu98194jfh9qgsq.descendants($_dw6wpu193jfh9qgsl.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_6caoqo192jfh9qgsj.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$4('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_edupdk172jfh9qgm8.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_2hytdv170jfh9qgly.map($_2hytdv170jfh9qgly.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_2hytdv170jfh9qgly.map($_2hytdv170jfh9qgly.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_2hytdv170jfh9qgly.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_2vkmxz191jfh9qgsc = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_edupdk172jfh9qgm8.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_2hytdv170jfh9qgly.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_2hytdv170jfh9qgly.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_2hytdv170jfh9qgly.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_2hytdv170jfh9qgly.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_2hytdv170jfh9qgly.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_2vkmxz191jfh9qgsc.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_8x5wh519bjfh9qgt8.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_ap36g2196jfh9qgsu.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_dw6wpu193jfh9qgsl.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_dw6wpu193jfh9qgsl.fromDom(element.parentNode), function (x) {
      return !$_aa5pc219ijfh9qgtw.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_2hytdv170jfh9qgly.find(scope.dom().childNodes, $_edupdk172jfh9qgm8.compose(predicate, $_dw6wpu193jfh9qgsl.fromDom));
    return result.map($_dw6wpu193jfh9qgsl.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_dw6wpu193jfh9qgsl.fromDom(element.childNodes[i])))
          return Option.some($_dw6wpu193jfh9qgsl.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_6pw25z19vjfh9qgvc.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_4mscml1a1jfh9qgvs.ancestor(scope, function (e) {
      return $_6pw25z19vjfh9qgvc.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_4mscml1a1jfh9qgvs.sibling(scope, function (e) {
      return $_6pw25z19vjfh9qgvc.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_4mscml1a1jfh9qgvs.child(scope, function (e) {
      return $_6pw25z19vjfh9qgvc.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_6pw25z19vjfh9qgvc.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_6pw25z19vjfh9qgvc.is, ancestor$1, scope, selector, isRoot);
  };
  var $_5h2n191a0jfh9qgvq = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_3d0w921a4jfh9qgw4.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_3d0w921a4jfh9qgw4.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_3d0w921a4jfh9qgw4.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_3d0w921a4jfh9qgw4.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    global$4.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_3d0w921a4jfh9qgw4.postRenderFormat(editor, name)
      });
    });
  };
  var $_6zkokg1a3jfh9qgw3 = { register: register };
  ...
  var $_zbbdj1a5jfh9qgw6 = { register: register$1 };
  ...
  var $_akgo511a6jfh9qgwh = { register: register$2 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_3d0w921a4jfh9qgw4.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_pk8k51a7jfh9qgwk = { register: register$3 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_3d0w921a4jfh9qgw4.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return global$4.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_3d0w921a4jfh9qgw4.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_dqcbac1a8jfh9qgwo = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_2hytdv170jfh9qgly.flatten(global$4.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_2hytdv170jfh9qgly.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_2hytdv170jfh9qgly.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_6h3llw1a9jfh9qgwr = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    global$4.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_3d0w921a4jfh9qgw4.postRenderFormat(editor, name),
        onclick: $_3d0w921a4jfh9qgw4.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_3d0w921a4jfh9qgw4.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_d19fpj1aajfh9qgwu = { register: register$6 };
  ...
  var $_9lt8b41abjfh9qgww = { register: register$7 };
  ...
  var $_e2az1u1acjfh9qgwx = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_5h2n191a0jfh9qgvq.descendant($_dw6wpu193jfh9qgsl.fromDom(document.body), editor.settings.ui_container).fold($_edupdk172jfh9qgm8.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_dqcbac1a8jfh9qgwo.register(editor);
    $_6zkokg1a3jfh9qgw3.register(editor);
    $_d19fpj1aajfh9qgwu.register(editor);
    $_9lt8b41abjfh9qgww.register(editor);
    $_akgo511a6jfh9qgwh.register(editor);
    $_zbbdj1a5jfh9qgw6.register(editor);
    $_pk8k51a7jfh9qgwk.register(editor);
    $_e2az1u1acjfh9qgwx.register(editor);
    $_6h3llw1a9jfh9qgwr.register(editor);
  };
  var $_65qw9u19zjfh9qgvn = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_8x5wh519bjfh9qgt8.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_8x5wh519bjfh9qgt8.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_a6v6m717gjfh9qgno,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_9w4fy17ujfh9qgp7,
      Panel: Panel,
      Movable: $_5e9tt517ijfh9qgns,
      Resizable: $_fzrwdz17vjfh9qgpa,
      ...
      FormatControls: $_65qw9u19zjfh9qgvn,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_65qw9u19zjfh9qgvn.setup(editor);
    $_2ne6o617xjfh9qgpe.addToEditor(editor, panel);
    return $_6v4zce16ejfh9qgl3.get(editor, panel);
  });
  function Theme () {
  }
