...
var emoticons = (function () {
  ...
  var $_xix6dajjfh9qaj3 = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_xix6dajjfh9qaj3.getHtml(pluginUrl);
  ...
  var $_b7fvmxaijfh9qait = { register: register };

  global.add('emoticons', function (editor, pluginUrl) {
    $_b7fvmxaijfh9qait.register(editor, pluginUrl);
  });
  function Plugin () {
  }
