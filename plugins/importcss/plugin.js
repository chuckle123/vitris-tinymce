...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_932q0se7jfh9qb3o.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_932q0se7jfh9qb3o.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_932q0se7jfh9qb3o.getSelectorConverter(editor)) {
      selectorConverter = $_932q0se7jfh9qb3o.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_932q0se7jfh9qb3o.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_932q0se7jfh9qb3o.getCssGroups(editor));
      ...
      if (!$_932q0se7jfh9qb3o.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_932q0se7jfh9qb3o.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_5v6vthe2jfh9qb3g.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_76ipmte1jfh9qb3e = { get: get };

  global.add('importcss', function (editor) {
    $_5v6vthe2jfh9qb3g.setup(editor);
    return $_76ipmte1jfh9qb3e.get(editor);
  });
  function Plugin () {
  }
